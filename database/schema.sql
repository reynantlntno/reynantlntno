...
DROP TABLE IF EXISTS `t_api_requests`;
DROP TABLE IF EXISTS `t_api_keys`;
DROP TABLE IF EXISTS `t_contact_messages`;
DROP TABLE IF EXISTS `t_newsletter_subscribers`;
...
DROP TABLE IF EXISTS `t_blog_posts`;
