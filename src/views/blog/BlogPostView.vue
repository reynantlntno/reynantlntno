<template>
  <div class="min-h-screen bg-carbon-950">
    ...
    <div v-else-if="currentPost" class="min-h-screen">
      <!-- Navigation Bar -->
      <nav class="sticky top-0 z-40 bg-carbon-900/95 backdrop-blur-sm border-b border-carbon-700/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
              <router-link 
                to="/blog" 
                class="flex items-center space-x-2 text-carbon-400 hover:text-accent-400 transition-colors font-mono text-sm"
              >
              ...
              <span class="text-carbon-400 font-mono text-sm truncate max-w-xs">
                {{ currentPost.slug }}
              </span>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-4">
              <div class="text-xs font-mono text-carbon-500">
                <span class="text-carbon-400">Reading:</span> 
                <span class="text-accent-400">{{ readingProgress }}%</span>
              </div>
              <div class="w-24 h-1 bg-carbon-700 rounded-full overflow-hidden">
                <div 
          ...
          <div class="bg-carbon-800/50 rounded-ide border border-carbon-700/50 overflow-hidden mb-8">
            ...
            <div class="p-8">
              ...
              <h1 class="text-3xl md:text-5xl font-bold text-carbon-100 mb-6 leading-tight font-mono">
                ...
                <span class="text-syntax-variable"> article</span>
                <span class="text-carbon-300"> = {</span>
                <br>
                <span class="text-carbon-300 ml-6">title: </span>
              ...
              <!-- Closing Bracket -->
              <div class="text-carbon-300 font-mono text-3xl md:text-5xl">
                <span>}</span>
              </div>
            </div>
          </div>
